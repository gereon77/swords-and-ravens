...
@observer
export default class StannisBaratheonASoSAbilityComponent extends Component<
  GameStateComponentProps<StannisBaratheonASoSAbilityGameState>
> {
  render(): ReactNode {
    return (
      <>
        <Col xs={12} className="text-center">
          <b>Stannis Baratheon</b>: House{" "}
          <b>{this.props.gameState.childGameState.house.name}</b> may choose to
          steal the Iron Throne dominance token and to gain a Sword Icon.
        </Col>
