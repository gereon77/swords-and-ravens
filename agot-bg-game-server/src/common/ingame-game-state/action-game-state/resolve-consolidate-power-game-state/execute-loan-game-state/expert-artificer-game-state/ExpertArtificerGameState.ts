...
export default class ExpertArtificerGameState extends GameState<
  ExecuteLoanGameState,
  SelectRegionGameState<ExpertArtificerGameState>
> {
  get game(): Game {
  ...
  static deserializeFromServer(
    ...
    data: SerializedExpertArtificerGameState
  ): ExpertArtificerGameState {
  ...
  deserializeChildGameState(
    data: SerializedExpertArtificerGameState["childGameState"]
  ): ExpertArtificerGameState["childGameState"] {
