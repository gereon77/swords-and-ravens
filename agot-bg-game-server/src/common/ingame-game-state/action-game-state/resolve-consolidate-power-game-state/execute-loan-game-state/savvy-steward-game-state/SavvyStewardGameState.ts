...
export default class SavvyStewardGameState extends GameState<
  ExecuteLoanGameState,
  SelectRegionGameState<SavvyStewardGameState>
> {
  get game(): Game {
  ...
  static deserializeFromServer(
    ...
    data: SerializedSavvyStewardGameState
  ): SavvyStewardGameState {
  ...
  deserializeChildGameState(
    data: SerializedSavvyStewardGameState["childGameState"]
  ): SavvyStewardGameState["childGameState"] {
