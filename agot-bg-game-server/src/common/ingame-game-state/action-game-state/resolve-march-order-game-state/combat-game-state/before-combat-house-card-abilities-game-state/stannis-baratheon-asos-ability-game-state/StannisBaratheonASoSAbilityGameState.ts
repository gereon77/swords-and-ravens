...
> {
  ...
  onSimpleChoiceGameStateEnd(choice: number): void {
    ...
    this.combatGameState.houseCardModifiers.set(
      stannisBaratheonASoS.id,
      houseCardModifier
    );
  ...
  serializeToClient(
    admin: boolean,
    player: Player | null
  ): SerializedStannisBaratheonASoSAbilityGameState {
    return {
  ...
  static deserializeFromServer(
    ...
    data: SerializedStannisBaratheonASoSAbilityGameState
  ): StannisBaratheonASoSAbilityGameState {
    const stannisAbility = new StannisBaratheonASoSAbilityGameState(
      houseCardResolution
    );

    stannisAbility.childGameState = stannisAbility.deserializeChildGameState(
      data.childGameState
    );
  ...
  deserializeChildGameState(
    data: SerializedStannisBaratheonASoSAbilityGameState["childGameState"]
  ): StannisBaratheonASoSAbilityGameState["childGameState"] {
