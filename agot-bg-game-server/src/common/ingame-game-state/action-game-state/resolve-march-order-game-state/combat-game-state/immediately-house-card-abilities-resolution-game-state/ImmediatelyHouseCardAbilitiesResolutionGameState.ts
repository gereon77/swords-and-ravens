...
import QueenOfThornsAbilityGameState, {
  SerializedQueenOfThornsAbilityGameState
} from "./queen-of-thorns-ability-game-state/QueenOfThornsAbilityGameState";
...
import DoranMartellAbilityGameState, {
  SerializedDoranMartellAbilityGameState
} from "./doran-martell-ability-game-state/DoranMartellAbilityGameState";
import AeronDamphairAbilityGameState, {
  SerializedAeronDamphairAbilityGameState
} from "./aeron-damphair-ability-game-state/AeronDamphairAbilityGameState";
import MaceTyrellAbilityGameState, {
  SerializedMaceTyrellAbilityGameState
} from "./mace-tyrell-ability-game-state/MaceTyrellAbilityGameState";
...
> {
  ...
  deserializeHouseCardResolutionChild(
    ...
    switch (data.type) {
      case "queen-of-thorns":
        return QueenOfThornsAbilityGameState.deserializeFromServer(
          houseCardResolution,
          data
        );
      case "doran-martell-ability":
        return DoranMartellAbilityGameState.deserializeFromServer(
          houseCardResolution,
          data
        );
      case "aeron-damphair-ability":
        return AeronDamphairAbilityGameState.deserializeFromServer(
          houseCardResolution,
          data
        );
      case "mace-tyrell-ability":
        return MaceTyrellAbilityGameState.deserializeFromServer(
          houseCardResolution,
          data
        );
      case "tyrion-lannister-ability":
        return TyrionLannisterAbilityGameState.deserializeFromServer(
          houseCardResolution,
          data
        );
    }
  ...
  static deserializeFromServer(
    ...
    data: SerializedImmediatelyHouseCardAbilitiesResolutionGameState
  ): ImmediatelyHouseCardAbilitiesResolutionGameState {
    const immediately = new ImmediatelyHouseCardAbilitiesResolutionGameState(
      combat
    );

    immediately.childGameState = immediately.deserializeChildGameState(
      data.childGameState
    );
  ...
  deserializeChildGameState(
    data: SerializedImmediatelyHouseCardAbilitiesResolutionGameState["childGameState"]
