...
import {
  footman,
  knight
} from "../../../../../../game-data-structure/unitTypes";
...
> {
  ...
  static deserializeFromServer(
    ...
    data: SerializedRenlyBaratheonAbilityGameState
  ): RenlyBaratheonAbilityGameState {
    const renlyBaratheonAbility = new RenlyBaratheonAbilityGameState(
      afterWinnerDeterminationChild
    );

    renlyBaratheonAbility.childGameState =
      renlyBaratheonAbility.deserializeChildGameState(data.childGameState);

    return renlyBaratheonAbility;
  }

  deserializeChildGameState(
    data: SerializedRenlyBaratheonAbilityGameState["childGameState"]
  ): SelectUnitsGameState<RenlyBaratheonAbilityGameState> {
