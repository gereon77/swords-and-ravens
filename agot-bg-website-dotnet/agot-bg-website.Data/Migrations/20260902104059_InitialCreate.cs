...
namespace agot_bg_website.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastActivity = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastActiveAt = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                },
            ...
            migrationBuilder.CreateIndex(name: "IX_Games_State", table: "Games", column: "State");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "PbemResponseTimes");

            migrationBuilder.DropTable(name: "PlayersInGame");

            migrationBuilder.DropTable(name: "PreviousPlayersInGame");

            migrationBuilder.DropTable(name: "UsersInRoom");
