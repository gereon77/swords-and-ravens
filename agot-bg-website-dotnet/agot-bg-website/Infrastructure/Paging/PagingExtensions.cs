...
public static class PagingExtensions
{
    ...
    /// <c>Pages/Shared/_Pager.cshtml</c> - keeps a tampered querystring/cookie value from
    ...
    /// <summary>
    /// Clamps a user-supplied (querystring or <see cref="PageSizeCookie"/>-sourced) page size into
